        ...
        match config.system.interconnect:
            case "garnet":
                return Garnet_Network(
                    ...
                    data_msg_size    = config.interconnect.garnet.data_width
                )
            case "simple":
                return Simple_Network(
                    ...
                    data_msg_size = config.interconnect.simple.data_width,
                    buffer_size = config.interconnect.simple.router_buffer_size 
                )
            case _:
                raise ValueError(f"Unknown network {config.system.interconnect}")
