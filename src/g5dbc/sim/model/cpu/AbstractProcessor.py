...
from g5dbc.sim.m5_objects import m5_switchCpus, m5_VoltageDomain, m5_SrcClockDomain
...
class AbstractProcessor(m5_SubSystem):
    ...
    def __init__( self, config: Config, core_keys: list[str], core_group: dict[str, list[AbstractCore]]) -> None:
        super().__init__()
